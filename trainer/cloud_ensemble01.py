...
# WE MAY WANT TO START BY SENDING EVERYTHING INTO THE ENSEMBLE
X_sendin = []
Y_sendin = []
count = 0
...
LSTM_baby = keras.wrappers.scikit_learn.KerasClassifier(build_fn=build_LSTM(), epochs=50, batch_size=50)
boosted_LSTM = sklearn.ensemble.AdaBoostRegressor(base_estimator=LSTM_baby, n_estimators=50, loss='square')
...
# train the ensemble
boosted_LSTM.fit(X_train, Y_train, epochs = 50, batch_size = 128, validation_data=(X_test, Y_test))
