...
*note: not ideal to run Audio models in here but I did it anyway
...
#VGG_02_all model
model_file = file_io.FileIO('gs://mediaeval_data_storage/models02/modelAudio02_all', mode='rb')
...
#modelVGG_CNN
model_file = file_io.FileIO('gs://mediaeval_data_storage/models01/modelAudioCNN', mode='rb')
