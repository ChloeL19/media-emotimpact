...
X_data = StringIO(file_io.read_file_to_string('gs://mediaeval_data_storage/DevSet01/resnet01.npy'))
...
# selecting only the matrices with fear-inducing seconds to send in for training
X_sendin = []
Y_sendin = []
count = 0
...
# adding a convolutional layer to compress size
model.add(Dense(4096, input_shape=(timesteps, data_dim), activation='sigmoid'))
