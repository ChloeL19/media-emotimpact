...
LSTM_baby = KerasClassifier(build_fn=build_LSTM(timesteps, data_dim), epochs=50, batch_size=50)
boosted_LSTM = AdaBoostRegressor(base_estimator=LSTM_baby, n_estimators=50, loss='square')
